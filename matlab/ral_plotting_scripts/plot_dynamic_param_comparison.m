...
folder = '/ral_data/';
filename = 'bayesian_dynamic_pg10.5_1pred.mat';
...
repo = what('hallucinate');
folder = '/ral_data/';
filename = 'bayesian_dynamic_pg10.9_1pred.mat';
load(strcat(repo.path, folder, filename));
...
repo = what('hallucinate');
folder = '/ral_data/';
filename = 'reach_dynamic_pg10.5_gamma0.5_delta0.03_1pred.mat';
load(strcat(repo.path, folder, filename));
...
repo = what('hallucinate');
folder = '/ral_data/';
filename = 'reach_dynamic_pg10.9_gamma0.5_delta0.03_1pred.mat';
load(strcat(repo.path, folder, filename));
