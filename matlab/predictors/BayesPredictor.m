classdef BayesPredictor
    ...
    methods
        ...
        function fullPreds = predict(obj, x0, H, v, dt, grid)
        ...
        function normPreds = renormalizeProbs(obj, preds, t, x0, v, dt, g)
            normPreds = preds{t};
            ...
            validPIndicies = find(normPreds > 0);
            invalidIndicies = setdiff(validPIndicies,validFRSIndicies);

            % Sum the probabilities of all invalid indicies to redistribute
            % pmass.
            probRedistribute = sum(normPreds(invalidIndicies));

            normPreds(invalidIndicies) = 0.0;
            normPreds(validFRSIndicies) = normPreds(validFRSIndicies) + ...
