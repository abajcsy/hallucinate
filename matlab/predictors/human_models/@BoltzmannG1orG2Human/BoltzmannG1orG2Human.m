classdef BoltzmannG1orG2Human < DynSys
    properties
    	% Fixed human speed
        v
    ...
    methods
        function obj = BoltzmannG1orG2Human(x, v, uRange, gamma, ...
                trueGoal, goals, delta_t, uThresh, numCtrls, betaModel, extraArgs)
        ...
        function pu = PuGivenGoal(obj, u, x, goalIdx)
            ...
            for i = 1:obj.numCtrls
                ...
                qval = obj.qFunction(x, u_i, obj.goals{goalIdx});
        ...
        function [likelyCtrls, likelyMasks] = getLikelyControls(obj, x)
            ...
            for i = 1:obj.numCtrls
                u = obj.discCtrls(i);
                if obj.trueGoal == 1
                    pu = obj.PuGivenGoal(u, x, 1);
                else
                    pu = obj.PuGivenGoal(u, x, 2);
                end
        ...
        function qval = qFunction(obj, x, u, theta)
